...
Command: npx gltfjsx@6.5.3 Vodka.glb -o second_transform_jsx/Vodka.jsx 
*/

import { useGLTF, useTexture } from '@react-three/drei';

export function Model({ theme, ...props }) {
    const { nodes } = useGLTF('/Vodka.glb');

    let tex1, tex2, color;
    if (theme == 'apothecary' || theme == 'summer') {
        [tex1, tex2] = useTexture(['/vodka_apo/baseColor_1.jpg', '/vodka_apo/baseColor_2.jpg']);
        tex1.flipY = false;
        tex2.flipY = false;
